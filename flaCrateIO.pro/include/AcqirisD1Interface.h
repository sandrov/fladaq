...
//
//----------------------------------------------------------------------------------------
//  Copyright Acqiris, Inc. 2001-2007
//
...
//   The only exceptions are the initialization functions '$prefixD1$_getNbrPhysicalInstruments',
//   '$prefixD1$_setSimulationOptions', '$prefixD1$_init' and '$prefixD1$_InitWithOptions'.
...
//                    as set with the function '$prefixD1$_configMemory'
// 'firstSample'    = requested position of first sample to read, typically 0. May assume 0 to
//                    (the number of samples - 1) as set with the function '$prefixD1$_configMemory'
// 'nbrSamples'     = requested number of samples, may assume 1 to the number of samples as
//                    set with the function '$prefixD1$_configMemory'
//
// Values returned by the function:
//
...
ACQ_DLL ViStatus ACQ_CC AcqrsD1_configAvgConfigInt32(ViSession instrumentID,
    ViInt32 channel, ViString parameterString, ViInt32 value);
//  Configures Averagers and Analyzer (APxxx)!
//
// Configures a ViInt32 parameter in the channel dependent averager/analyzer configuration 'channel'
// 'channel'        = 1...Nchan
//                  = 0 (selecting channel 1) is supported for backwards compatibility
//
// 'parameterString'= character string specifying the requested parameter
//                    Please refer to the manual for the accepted parameter strings
// 'value'          = value to set
//                    This function should be called only for 'parameterString'
//                    that accepts a data of integer type. Please refer to the manual
//                    for the list of available 'parameterString'.
//
// Returns one of the following ViStatus values:
// ACQIRIS_ERROR_NOT_SUPPORTED        if this function is not supported by the instrument.
// ACQIRIS_ERROR_PARAM_STRING_INVALID if 'parameterString' is invalid.
...
ACQ_DLL ViStatus ACQ_CC AcqrsD1_configAvgConfigReal64(ViSession instrumentID,
    ViInt32 channel, ViString parameterString, ViReal64 value);
//  Configures Averagers and Analyzer (APxxx)!
//
// Configures a ViReal64 parameter in the channel dependent averager/analyzer configuration 'channel'
// 'channel'        = 1...Nchan
//                  = 0 (selecting channel 1) is supported for backwards compatibility
//
// 'parameterString'= character string specifying the requested parameter
...
// 'value'          = value to set
//                    This function should be called only for 'parameterString'
//                    that accepts a data of floating point value type. Please refer to
//                    the manual for the list of available 'parameterString'.
//
// Returns one of the following ViStatus values:
// ACQIRIS_ERROR_NOT_SUPPORTED        if this function is not supported by the instrument.
// ACQIRIS_ERROR_PARAM_STRING_INVALID if 'parameterString' is invalid.
...
ACQ_DLL ViStatus ACQ_CC AcqrsD1_getAvgConfigInt32(ViSession instrumentID,
    ViInt32 channel, ViString parameterString, ViInt32 *valueP);
//  Returns a parameter from the averager/analyzer configuration
//  See remarks under '$prefixD1$_configAvgConfigInt32'
//
// Returns one of the following ViStatus values:
// ACQIRIS_ERROR_PARAM_STRING_INVALID if 'parameterString' is invalid.
// ACQIRIS_ERROR_NOT_SUPPORTED        if this function is not supported by the
...
ACQ_DLL ViStatus ACQ_CC AcqrsD1_getAvgConfigReal64(ViSession instrumentID,
    ViInt32 channel, ViString parameterString, ViReal64 *valueP);
//  Returns a parameter from the averager/analyzer configuration
//    See remarks under '$prefixD1$_configAvgConfigReal64'
//
// Returns one of the following ViStatus values:
// ACQIRIS_ERROR_PARAM_STRING_INVALID if 'parameterString' is invalid.
// ACQIRIS_ERROR_NOT_SUPPORTED        if this function is not supported by the
...
// See remarks under '$prefixD1$_InitWithOptions'
...
// This function is faster than a loop over '$prefixD1$_readCharWform()' if many
...
//                    of segments set with the function '$prefixD1$_configMemory'.
// 'sampTime'       = sampling interval in seconds
// 'vGain'          = vertical gain in Volts/LSB
// 'vOffset'        = vertical offset in Volts
//                    The value in Volts of a data point 'data' in the returned
...
//                    number of segments set with the function '$prefixD1$_configMemory'.
...
// This function is faster than a loop over '$prefixD1$_readRealWform()' if many
// short segments (< 10'000 points/segment) are read.
//
// See remarks under '$prefixD1$_readCharSequence'
...
//
// See remarks under '$prefixD1$_readCharWform'
...
//
// 'channel'            = 1...Nchan (as returned by '$prefixD1$_getNbrChannels' ) or
...
// Sets one or several options which will be used by the function '$prefixD1$_InitWithOptions',
// provided that the 'optionString' supplied to '$prefixD1$_InitWithOptions' contains the
